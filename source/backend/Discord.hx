...
class DiscordClient
{
	...
	private static final _defaultID:String = "1322551461405659246";
	...
	private static function onReady(request:cpp.RawConstPointer<DiscordUser>):Void {
		...
		button.url = "https://github.com/SantiagoEngine/SantiagoEngine/releases";
		presence.buttons[0] = button;

		final button2:DiscordButton = DiscordButton.create();
		button2.label = "GitHub link";
		button2.url = "https://github.com/SantiagoEngine/SantiagoEngine";
