...
class Paths
{
	...
	static public function gif(key:String, ?folder:String):String
	{
		#if MODS_ALLOWED
			var file:String = modsGifs(key);
			if(FileSystem.exists(file)) return file;
		#end
			return getPath('images/gifs/$key.$GIF_EXT', BINARY, folder, true);
	}
	...
	inline static public function modsGifs(key:String)
		return modFolders('images/gifs/' + key + '.$GIF_EXT');
