...
class ModsCreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		if (creditsStuff.length == 0) {
			var noModsText:FlxText = new FlxText(0, FlxG.height / 2 - 10, FlxG.width, "No mods installed.", 32);
		...
		if (curSelected >= 0 && curSelected < creditsStuff.length && creditsStuff[curSelected].length > 4) { // crash fix
